function [sgates,errors]=iaawt_dualtree(data_array,numsurrogates,accerror,error_change)
...
%wavelet decomp
[Yl,Yh] = dualtree(data_array,'Level',numlevels,'LevelOneFilter','nearsym5_7','FilterLength',14);
...
for surrloop=1:numsurrogates
    ...
    [Zl,Zh] = dualtree(z,'Level',numlevels,'LevelOneFilter','nearsym5_7','FilterLength',14);
    ...
    while (amperror(counter) > accerror) && (waverror(counter) > accerror)
        ...
        z=idualtree(Yl,newZh,'LevelOneFilter','nearsym5_7','FilterLength',14);
        ...
        %Wavelet step
        [nZl,nZh] = dualtree(z,'Level',numlevels,'LevelOneFilter','nearsym5_7','FilterLength',14);  
